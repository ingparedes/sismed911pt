...
// Create page object
$Controlintemaster = new Controlintemaster();

// Run the page
$Controlintemaster->run();
						...
						<div class="row">
							<div class="col-lg-12">
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									...
									<li class="nav-item" role="presentation">
										<a class="nav-link" id="ambulance-tab" data-toggle="tab" href="#ambulance" role="tab" aria-controls="ambulance" aria-selected="false"><?php echo $Language->Phrase("fa_ambulance"); ?></a>
									</li>
								</ul>
...
<script>
	ew.ready("makerjs", "<?php echo $RELATIVE_PATH ?>js/interhM.js", "interhM");
</script>

<?php if (Config("DEBUG")) echo GetDebugMessage(); ?>
<?php include_once "footer.php"; ?>
<?php
$Controlintemaster->terminate();
?>