...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "sismed911"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'Mrndp4Ui7QUnlVeS', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/sismed911.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{17BEB368-DB80-46DC-8EC5-730EB11B94E5}", // Project ID (GUID)
	...
	"NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-gray navbar-dark border-bottom",
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "POSTGRESQL", "qs" => "\"", "qe" => "\"", "host" => "localhost", "port" => "5432", "user" => "postgres", "pass" => "root", "db" => "sisme911", "schema" => "public"]
	],
	...
	"ADMIN_USER_NAME" => "master", // Administrator user name
	"ADMIN_PASSWORD" => "peru", // Administrator password
	...
	"PASSWORD_HASH" => TRUE, // Use PHP 5.5+ password hashing functions
	...
	"SMTP_SERVER_USERNAME" => " smtp.gmail.com", // SMTP server user name
	"SMTP_SERVER_PASSWORD" => "dp970417", // SMTP server password
	"SENDER_EMAIL" => "dparedesrd@gmail.com", // Sender email address
	"RECIPIENT_EMAIL" => "dparedesrd@gmail.com", // Recipient email address
	...
	*/
	...
	"BASIC_SEARCH_ANY_FIELDS" => TRUE, // Search "All keywords" in any selected fields
...
$LANGUAGES = [["en","","english.xml"],["fr","","frances.xml"],["pt","","Portuguese.xml"],["es","","spanish.xml"]];
