 ...
 * Page class
 */
class obstetrico_registro_edit extends obstetrico_registro
{
	...
	// Page object name
	public $PageObjName = "obstetrico_registro_edit";
	...
	protected function newRow()
	{
		...
		$row['trabajoparto'] = NULL;
		$row['sangradovaginal'] = NULL;
		$row['g'] = NULL;
		$row['p'] = NULL;
		$row['a'] = NULL;
		$row['n'] = NULL;
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// trabajoparto
			$this->trabajoparto->setDbValueDef($rsnew, $this->trabajoparto->CurrentValue, NULL, $this->trabajoparto->ReadOnly);

			// sangradovaginal
			$this->sangradovaginal->setDbValueDef($rsnew, $this->sangradovaginal->CurrentValue, NULL, $this->sangradovaginal->ReadOnly);
