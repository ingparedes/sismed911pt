 ...
 * Page class
 */
class pacientegeneral_edit extends pacientegeneral
{
	...
	// Page object name
	public $PageObjName = "pacientegeneral_edit";
	...
	public function run()
	{
		...
		$this->prehospitalario->Visible = FALSE;
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// cod_casointerh
			$this->cod_casointerh->setDbValueDef($rsnew, $this->cod_casointerh->CurrentValue, 0, $this->cod_casointerh->ReadOnly);

			// expendiente
			$this->expendiente->setDbValueDef($rsnew, $this->expendiente->CurrentValue, NULL, $this->expendiente->ReadOnly);

			// tipo_doc
			$this->tipo_doc->setDbValueDef($rsnew, $this->tipo_doc->CurrentValue, NULL, $this->tipo_doc->ReadOnly);

			// num_doc
			$this->num_doc->setDbValueDef($rsnew, $this->num_doc->CurrentValue, NULL, $this->num_doc->ReadOnly);

			// nombre1
			$this->nombre1->setDbValueDef($rsnew, $this->nombre1->CurrentValue, NULL, $this->nombre1->ReadOnly);

			// nombre2
			$this->nombre2->setDbValueDef($rsnew, $this->nombre2->CurrentValue, NULL, $this->nombre2->ReadOnly);

			// apellido1
			$this->apellido1->setDbValueDef($rsnew, $this->apellido1->CurrentValue, NULL, $this->apellido1->ReadOnly);

			// apellido2
			$this->apellido2->setDbValueDef($rsnew, $this->apellido2->CurrentValue, NULL, $this->apellido2->ReadOnly);

			// genero
			$this->genero->setDbValueDef($rsnew, $this->genero->CurrentValue, NULL, $this->genero->ReadOnly);

			// edad
			$this->edad->setDbValueDef($rsnew, $this->edad->CurrentValue, NULL, $this->edad->ReadOnly);

			// fecha_nacido
			$this->fecha_nacido->setDbValueDef($rsnew, $this->fecha_nacido->CurrentValue, NULL, $this->fecha_nacido->ReadOnly);

			// cod_edad
			$this->cod_edad->setDbValueDef($rsnew, $this->cod_edad->CurrentValue, NULL, $this->cod_edad->ReadOnly);
			...
			// aseguradro
			$this->aseguradro->setDbValueDef($rsnew, $this->aseguradro->CurrentValue, NULL, $this->aseguradro->ReadOnly);

			// observacion
			$this->observacion->setDbValueDef($rsnew, $this->observacion->CurrentValue, NULL, $this->observacion->ReadOnly);

			// nss
			$this->nss->setDbValueDef($rsnew, $this->nss->CurrentValue, NULL, $this->nss->ReadOnly);
	...
	function Page_Render() {
		...
		$this->id_paciente->EditValue = htmlspecialchars($_GET["cod_casointerh"]);
