 ...
 * Page class
 */
class bloques_div_edit extends bloques_div
{
	...
	// Page object name
	public $PageObjName = "bloques_div_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// bloque
			$this->bloque->setDbValueDef($rsnew, $this->bloque->CurrentValue, NULL, $this->bloque->ReadOnly);
			...
			$this->activo->setDbValueDef($rsnew, $tmpBool, NULL, $this->activo->ReadOnly);
