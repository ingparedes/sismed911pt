 ...
 * Page class
 */
class Dashboard2_dashboard extends ReportTable
{
	...
	// Table name
	public $TableName = 'Dashboard2';

	// Page object name
	public $PageObjName = "Dashboard2_dashboard";
	...
	public function __construct()
	{
		...
		// Table object (interh_hospitales)
		if (!isset($GLOBALS['interh_hospitales']))
			$GLOBALS['interh_hospitales'] = new interh_hospitales();
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'Dashboard2');
	...
	public $ItemClassNames = ["col-sm-12","col-sm-12","col-sm-12","col-sm-12"];
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'Dashboard2');
			if ($Security->isLoggedIn())
