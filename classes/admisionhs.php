...
class admisionhs
{
	...
	// Table name
	public $TableName = 'admisionhs.php';

	// Page object name
	public $PageObjName = "admisionhs";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'admisionhs.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "admisionhs", $url, "", "admisionhs", TRUE);
		$this->Heading = $Language->TablePhrase("admisionhs", "TblCaption"); 
	}
} // End class
?>