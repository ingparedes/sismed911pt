 ...
 * Page class
 */
class medicamentos_registros_edit extends medicamentos_registros
{
	...
	// Page object name
	public $PageObjName = "medicamentos_registros_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// medicamentos_id
			$this->medicamentos_id->setDbValueDef($rsnew, $this->medicamentos_id->CurrentValue, NULL, $this->medicamentos_id->ReadOnly);
