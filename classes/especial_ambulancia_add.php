 ...
 * Page class
 */
class especial_ambulancia_add extends especial_ambulancia
{
	...
	// Page object name
	public $PageObjName = "especial_ambulancia_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_especialambulancia") !== NULL) {
				...
				$this->setKey("id_especialambulancia", $this->id_especialambulancia->CurrentValue); // Set up key
			} else {
				$this->setKey("id_especialambulancia", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "especial_ambulanciaview.php")
