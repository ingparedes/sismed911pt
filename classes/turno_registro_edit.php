 ...
 * Page class
 */
class turno_registro_edit extends turno_registro
{
	...
	// Page object name
	public $PageObjName = "turno_registro_edit";
	...
	protected function newRow()
	{
		...
		$row['km_actual'] = NULL;
		$row['combustible_actual'] = NULL;
		$row['cantidadtiket'] = NULL;
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// km_actual
			$this->km_actual->setDbValueDef($rsnew, $this->km_actual->CurrentValue, NULL, $this->km_actual->ReadOnly);

			// combustible_actual
			$this->combustible_actual->setDbValueDef($rsnew, $this->combustible_actual->CurrentValue, NULL, $this->combustible_actual->ReadOnly);

			// cantidadtiket
			$this->cantidadtiket->setDbValueDef($rsnew, $this->cantidadtiket->CurrentValue, NULL, $this->cantidadtiket->ReadOnly);
