 ...
 * Page class
 */
class Dashboard1_dashboard extends ReportTable
{
	...
	// Table name
	public $TableName = 'Dashboard1';

	// Page object name
	public $PageObjName = "Dashboard1_dashboard";
	...
	public $ItemClassNames = ["col-sm-12","col-sm-12","col-sm-12","col-sm-12","col-sm-12","col-sm-12"];
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'Dashboard1');
			if ($Security->isLoggedIn())
