 ...
 * Page class
 */
class sala_admision_edit extends sala_admision
{
	...
	// Page object name
	public $PageObjName = "sala_admision_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// nombre_confirma
			$this->nombre_confirma->setDbValueDef($rsnew, $this->nombre_confirma->CurrentValue, NULL, $this->nombre_confirma->ReadOnly);

			// paciente
			$this->paciente->setDbValueDef($rsnew, $this->paciente->CurrentValue, NULL, $this->paciente->ReadOnly);
