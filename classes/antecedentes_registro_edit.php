 ...
 * Page class
 */
class antecedentes_registro_edit extends antecedentes_registro
{
	...
	// Page object name
	public $PageObjName = "antecedentes_registro_edit";
	...
	protected function newRow()
	{
		...
		$row['diabetes'] = NULL;
		$row['cardiopatia'] = NULL;
		$row['convulsiones'] = NULL;
		$row['asmabronquitis'] = NULL;
		$row['acv'] = NULL;
		$row['has'] = NULL;
		$row['alergia'] = NULL;
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// diabetes
			$this->diabetes->setDbValueDef($rsnew, $this->diabetes->CurrentValue, NULL, $this->diabetes->ReadOnly);

			// cardiopatia
			$this->cardiopatia->setDbValueDef($rsnew, $this->cardiopatia->CurrentValue, NULL, $this->cardiopatia->ReadOnly);

			// convulsiones
			$this->convulsiones->setDbValueDef($rsnew, $this->convulsiones->CurrentValue, NULL, $this->convulsiones->ReadOnly);

			// asmabronquitis
			$this->asmabronquitis->setDbValueDef($rsnew, $this->asmabronquitis->CurrentValue, NULL, $this->asmabronquitis->ReadOnly);

			// acv
			$this->acv->setDbValueDef($rsnew, $this->acv->CurrentValue, NULL, $this->acv->ReadOnly);

			// has
			$this->has->setDbValueDef($rsnew, $this->has->CurrentValue, NULL, $this->has->ReadOnly);

			// alergia
			$this->alergia->setDbValueDef($rsnew, $this->alergia->CurrentValue, NULL, $this->alergia->ReadOnly);

			// medicamentos
			$this->medicamentos->setDbValueDef($rsnew, $this->medicamentos->CurrentValue, NULL, $this->medicamentos->ReadOnly);

			// otros
			$this->otros->setDbValueDef($rsnew, $this->otros->CurrentValue, NULL, $this->otros->ReadOnly);
