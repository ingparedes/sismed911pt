 ...
 * Page class
 */
class insumos_registros_edit extends insumos_registros
{
	...
	// Page object name
	public $PageObjName = "insumos_registros_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// insumos_id
			$this->insumos_id->setDbValueDef($rsnew, $this->insumos_id->CurrentValue, NULL, $this->insumos_id->ReadOnly);
