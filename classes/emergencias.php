...
class emergencias
{
	...
	// Table name
	public $TableName = 'emergencias.php';

	// Page object name
	public $PageObjName = "emergencias";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'emergencias.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "emergencias", $url, "", "emergencias", TRUE);
		$this->Heading = $Language->TablePhrase("emergencias", "TblCaption"); 
	}
} // End class
?>