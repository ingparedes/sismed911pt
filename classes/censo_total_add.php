 ...
 * Page class
 */
class censo_total_add extends censo_total
{
	...
	// Page object name
	public $PageObjName = "censo_total_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_censo") !== NULL) {
				...
				$this->setKey("id_censo", $this->id_censo->CurrentValue); // Set up key
			} else {
				$this->setKey("id_censo", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "censo_totalview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->cod_servicio->CurrentValue = NULL;
		$this->cod_servicio->OldValue = $this->cod_servicio->CurrentValue;
		$this->cod_division->CurrentValue = NULL;
		$this->cod_division->OldValue = $this->cod_division->CurrentValue;
		$this->camas_ocupadas->CurrentValue = NULL;
		$this->camas_ocupadas->OldValue = $this->camas_ocupadas->CurrentValue;
		$this->camas_libres->CurrentValue = NULL;
		$this->camas_libres->OldValue = $this->camas_libres->CurrentValue;
		$this->camas_fueraservicio->CurrentValue = NULL;
		$this->camas_fueraservicio->OldValue = $this->camas_fueraservicio->CurrentValue;
		$this->nombre_reporta->CurrentValue = NULL;
		$this->nombre_reporta->OldValue = $this->nombre_reporta->CurrentValue;
		$this->telefono_reporta->CurrentValue = NULL;
		$this->telefono_reporta->OldValue = $this->telefono_reporta->CurrentValue;
		...
		$this->id_censo->OldValue = $this->id_censo->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row['cod_servicio'] = $this->cod_servicio->CurrentValue;
		$row['cod_division'] = $this->cod_division->CurrentValue;
		$row['camas_ocupadas'] = $this->camas_ocupadas->CurrentValue;
		$row['camas_libres'] = $this->camas_libres->CurrentValue;
		$row['camas_fueraservicio'] = $this->camas_fueraservicio->CurrentValue;
		$row['nombre_reporta'] = $this->nombre_reporta->CurrentValue;
		$row['telefono_reporta'] = $this->telefono_reporta->CurrentValue;
		$row['fecha_reporte'] = $this->fecha_reporte->CurrentValue;
		$row['id_censo'] = $this->id_censo->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// cod_servicio
		$this->cod_servicio->setDbValueDef($rsnew, $this->cod_servicio->CurrentValue, NULL, FALSE);

		// cod_division
		$this->cod_division->setDbValueDef($rsnew, $this->cod_division->CurrentValue, NULL, FALSE);

		// camas_ocupadas
		$this->camas_ocupadas->setDbValueDef($rsnew, $this->camas_ocupadas->CurrentValue, NULL, FALSE);

		// camas_libres
		$this->camas_libres->setDbValueDef($rsnew, $this->camas_libres->CurrentValue, NULL, FALSE);

		// camas_fueraservicio
		$this->camas_fueraservicio->setDbValueDef($rsnew, $this->camas_fueraservicio->CurrentValue, NULL, FALSE);

		// nombre_reporta
		$this->nombre_reporta->setDbValueDef($rsnew, $this->nombre_reporta->CurrentValue, NULL, FALSE);

		// telefono_reporta
		$this->telefono_reporta->setDbValueDef($rsnew, $this->telefono_reporta->CurrentValue, NULL, FALSE);

		// fecha_reporte
		$this->fecha_reporte->setDbValueDef($rsnew, UnFormatDateTime($this->fecha_reporte->CurrentValue, 0), NULL, FALSE);
