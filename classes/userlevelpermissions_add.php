...
class userlevelpermissions_add extends userlevelpermissions
{
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "userlevelpermissionslist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "userlevelpermissionsview.php")
	...
	protected function loadOldRecord()
	{
		...
		if (strval($this->getKey("_tablename")) != "")
			$this->_tablename->OldValue = $this->getKey("_tablename"); // tablename
		else
			$validKey = FALSE;
