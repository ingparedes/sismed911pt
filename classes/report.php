...
class report
{
	...
	// Table name
	public $TableName = 'report.php';

	// Page object name
	public $PageObjName = "report";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'report.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "report", $url, "", "report", TRUE);
		$this->Heading = $Language->TablePhrase("report", "TblCaption"); 
	}
} // End class
?>