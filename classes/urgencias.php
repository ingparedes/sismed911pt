...
class urgencias
{
	...
	// Table name
	public $TableName = 'urgencias.php';

	// Page object name
	public $PageObjName = "urgencias";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'urgencias.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "urgencias", $url, "", "urgencias", TRUE);
		$this->Heading = $Language->TablePhrase("urgencias", "TblCaption"); 
	}
} // End class
?>