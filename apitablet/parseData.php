...
{    
    ...
    function getCasoPDF($id_caso)
    {
        $dataset = array();
        $dataset["items"] = array();
        $datos = new getData();
        $res = $datos->getCasosPDF($id_caso);
    ...
    function getCasoTrauma($cod_caso)
    {
        $dataset = array();
        $dataset["items"] = array();
        $datos = new getData();
        $res = $datos->getTraumasCaso($cod_caso);
    ...
    function getCasoExpG($cod_caso)
    {
        $dataset = array();
        $dataset["items"] = array();
        $datos = new getData();
        $res = $datos->getExpGCaso($cod_caso);
    ...
    function getCasoExpF($cod_caso)
    {
        $dataset = array();
        $dataset["items"] = array();
        $datos = new getData();
        $res = $datos->getExpFCaso($cod_caso);
    ...
    function getCasoMedicamento($cod_caso)
    {
        $dataset = array();
        $dataset["items"] = array();
        $datos = new getData();
        $res = $datos->getMedicamentoCaso($cod_caso);
    ...
    function getCasoInsumo($cod_caso)
    {
        $dataset = array();
        $dataset["items"] = array();
        $datos = new getData();
        $res = $datos->getInsumoCaso($cod_caso);
    ...
    function getCasoProcedimiento($cod_caso)
    {
        $dataset = array();
        $dataset["items"] = array();
        $datos = new getData();
        $res = $datos->getProcCaso($cod_caso);
    ...
    function getCasoDiagnostico($cod_caso)
    {
        $dataset = array();
        $dataset["items"] = array();
        $datos = new getData();
        $res = $datos->getDiagnosticoCaso($cod_caso);
    ...
    function getCasoObstetrico($cod_caso)
    {
        $dataset = array();
        $dataset["items"] = array();
        $datos = new getData();
        $res = $datos->getObstCaso($cod_caso);
    ...
    }function getPaciCaso($cod_caso)
    {
        $dataset = array();
        $dataset["items"] = array();
        $datos = new getData();
        $res = $datos->getPaciCaso($cod_caso);
        ...
        if ($res->rowCount()) {
            ...
            echo json_encode(array('mensaje' => 'No hay Existe registro de paciente relacionado con el Caso'));
        }
    }
}
