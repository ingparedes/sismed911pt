...
<!DOCTYPE html>
  ...
  <body>
	<div class="container-fluid">
	  <div class="row">
		<div class="col-lg-12">
		  <table id="tableMaestro" class="table table-striped  table-sm" style="width: 100%">
	...
	<script type="text/javascript" src="js/prehM.js"></script>
  </body>
</html>
